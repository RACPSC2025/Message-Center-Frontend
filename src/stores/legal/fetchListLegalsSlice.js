...
export const fetchListLegals = createAsyncThunk(
  'legal/list_legals_amatia_express',
...
export const fetchListLegalsComplete = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      //console.log(query);
      const response = await axiosInstance.post('/message_center_api/legal_api/list_legals_amatia_express');
...
export const bedrock_query_deep = createAsyncThunk(
  'legal/bedrock_query',
  async ({ prompt, sessionId = null }, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.post(
...
export const bedrock_query_knowledge_base = createAsyncThunk(
  'legal/bedrock_query_knowledge_base',
  async ({ prompt, sessionId = null }, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.post(
        '/message_center_api/legal_api/bedrock_query_knowledge_base',
        {
          prompt,
          sessionId
        },
