...
const TaskDetailsSidebar = ({ selectedTask, statuses, onCollapse }) => {
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'white' }}>
      {/* Header del Ciclo */}
      <Box sx={{ p: 3, borderBottom: '1px solid #f0f0f0', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <Box>
      ...
      <Box sx={{ p: 3, flex: 1, overflowY: 'auto' }}>
        ...
        <Box mb={3}>
          ...
          <Paper elevation={0} sx={{ p: 1.5, display: 'flex', alignItems: 'center', bgcolor: '#f8fbfc', borderRadius: 2, mb: 1 }}>
            <Avatar sx={{ width: 32, height: 32, bgcolor: '#e3f2fd', color: '#1a90ff', fontSize: '0.8rem', fontWeight: 700, mr: 2 }}>AM</Avatar>
            <Box flex={1}>
              <Typography sx={{ fontWeight: 700, fontSize: '0.85rem' }}>A. Martinez</Typography>
              <Typography variant="caption" sx={{ color: '#90a4ae', fontWeight: 600 }}>JEFE SEGURIDAD</Typography>
            </Box>
        ...
        <Box mb={3}>
          ...
          <Paper elevation={0} sx={{ p: 1.5, display: 'flex', alignItems: 'center', bgcolor: '#f8fbfc', borderRadius: 2 }}>
            <Avatar sx={{ width: 32, height: 32, bgcolor: '#f1f8e9', color: '#689f38', fontSize: '0.8rem', fontWeight: 700, mr: 2 }}>JR</Avatar>
            <Box flex={1}>
              <Typography sx={{ fontWeight: 700, fontSize: '0.85rem' }}>J. Rodriguez</Typography>
              <Typography variant="caption" sx={{ color: '#90a4ae', fontWeight: 600 }}>BRIGADISTA</Typography>
            </Box>
        ...
        {/* Actividad Reciente */}
        <Box mb={3}>
          <Typography sx={{ fontSize: '0.8rem', fontWeight: 800, color: '#90a4ae', mb: 2 }}>💬 ACTIVIDAD RECIENTE</Typography>
          
          <Box display="flex" gap={1.5} mb={2}>
            <Avatar sx={{ width: 28, height: 28, bgcolor: '#e3f2fd', color: '#1a90ff', fontSize: '0.7rem' }}>AM</Avatar>
            <Box>
              <Typography sx={{ fontWeight: 700, fontSize: '0.8rem' }}>A. Martinez</Typography>
              <Box sx={{ bgcolor: '#f5f7f9', p: 1.5, borderRadius: '0 12px 12px 12px', mt: 0.5 }}>
                <Typography variant="body2" sx={{ fontSize: '0.8rem', color: '#455a64' }}>
                  He revisado los certificados. Se requiere adjuntar la vigencia de la licencia.
                </Typography>
                <Paper elevation={0} sx={{ mt: 1, p: 1, display: 'flex', alignItems: 'center', gap: 1, border: '1px solid #e0e0e0', borderRadius: 1 }}>
