...
import FindingsCardViewList from './FindingsCardViewList';
      ...
      <BaseFeaturePageLayout>
        <Box className="px-5 py-2">
          <Box className="xl:flex items-center justify-between gap-6 w-full py-2 mb-2">
            <Box className="flex items-center justify-center gap-6 py-3">
              ...
              <Button variant="outlined" color="primary" onClick={handleClearGeoFilter}>
                {t('clear_filters')}
              </Button>
            </Box>
        ...
        <FindingsDrawer
          ...
          drawerTitle={viewType === 'view_finding' ? 'Findings Details' : 'Findings Comment(s)'}
        />
      </BaseFeaturePageLayout>
    </Box>
  );
...
Component.displayName = 'Findings';
