# Reporte de Pruebas E2E — 22/4/2026, 3:56:36 p. m.

> **Módulo revisado:** Actions CRUD  
> **Ruta:** `http://localhost:3000/#/view/actions`  
> **Resultado global:** ✅ PASÓ  
> **Tests:** 11 total — ✅ 11 pasaron · ❌ 0 fallaron  
> **Duración total:** 142.5s  
...
| Tipo | Ruta |
|------|------|
| 📄 Este reporte | `test/results/2026-04-22_15-56-36_actions-crud_results.md` |
...
_Generado automáticamente por `test/md-reporter.js` — 2026-04-22T20:58:59.441Z_
